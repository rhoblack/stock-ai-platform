...
- [ ] backend pytest + frontend vitest + e2e + build 4 게이트 그린 (Phase E 재확인은 sandbox 권한 이슈로 미완료. 직전 Phase D 게이트: backend 382 / vitest 60 / build / e2e 9 통과)
- [ ] tag `v0.4-final` + push
...
- [ ] HoldingCheckEngine report/theme 보조 근거 통합 검토
- [ ] 관심종목 / 즐겨찾기
- [ ] 인증 / 권한
- [ ] 실제 News / Fundamental / Earnings 파이프라인
- [ ] Dependabot / CI 운영 보강
- [ ] 운영 DB migration 스크립트 정리
- [ ] 자동매매 / 실주문 / POST 트리거는 v0.5 Backlog 에 넣지 않음 — 별도 보안·컴플라이언스·리스크 사이클 필요
