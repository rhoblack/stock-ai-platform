...
## Phase B — KIS real order transport with mock-only tests ⏳ (대기)

상세: PLAN-0017 Phase B. `HttpxKisOrderTransport` (KisOrderClientInterface 첫 실 구현체) +
respx 100% mock + 마스킹 + broker_order_no SHA-256.
