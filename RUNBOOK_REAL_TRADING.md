...
> **v1.0-final 마감** (2026-05-09). 본 문서는 v1.0 **Small Approval Trading Release** 의
> 운영 진입·차단·복구 절차를 정리한다. 실 KIS 주문은 v0.1~v0.16 의 모든 dry-run 인프라가
> 검증된 위에서만, 그리고 운영자가 본 문서의 §1 전제 조건을 모두 통과한 다음에만 활성화 가능하다.
>
